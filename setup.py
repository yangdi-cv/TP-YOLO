...
README = (PARENT / 'ultralytics/README.md').read_text(encoding='utf-8')
REQUIREMENTS = [f'{x.name}{x.specifier}' for x in pkg.parse_requirements((PARENT / 'ultralytics/requirements.txt').read_text())]
